      ...
      >
        <div className="mx-auto max-w-7xl px-4 md:px-8 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <div className="relative h-8 w-8 rounded-2xl bg-gradient-to-br from-emerald-400 via-emerald-300 to-sky-400 shadow-[0_0_24px_rgba(16,185,129,0.8)] flex items-center justify-center">
              <svg className="h-5 w-5 text-slate-950" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="block w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-slate-800/50 hover:text-red-300 transition-colors border-t border-slate-800/50 mt-1"
                      >
                        Log out
                      </button>
                    </motion.div>
